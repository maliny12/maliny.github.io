...
---
<div class="container">
  <div class="text text-left" id="text-left">Maliny</div>
  <div class="text text-right" id="text-right">Po</div>
  <div class="text" id="combined">Maliny Po</div>
  <div class="mini" id="after">Personal Website</div>
</div>
